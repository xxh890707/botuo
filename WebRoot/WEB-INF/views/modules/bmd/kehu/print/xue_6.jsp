...
<body>
        ...
        <div class="printbox_kh fontsize_14">
            ...
            <div class="ewm_kh" id="qrcode_${r.id }"></div>
            ...
            <table cellpadding="0" cellspacing="0" class="table_2 fontsize_16" style="line-height: 18px; font-size: 17px;">
                <tr>
            ...
            <table cellpadding="0" cellspacing="0" class="table2 fontsize_15">
                <tr>
            ...
            <div class="nbsp_5"></div>
            <table cellpadding="0" cellspacing="0" class="table2 fontsize_14">
                <tr>
        ...
        <script type="text/javascript">
			jQuery('#qrcode_${r.id}').qrcode({
				...
				right: "1.8cm",
				top: "1cm",
			    text: "http://www.bt-healthy.com/f/report/form?id=${r.id}&type=2"
			});
        </script>
        </c:forEach>
        <!-- printend -->
