...
<body>
        <!-- printstart -->
            ...
            <table cellpadding="0" cellspacing="0" class="table">
                ...
                <tr>
                    ...
                    <c:forEach items="${r.elements}" var="e">
                    	...
                    	<td style="font-weight: bold;"><fmt:formatNumber type="number" value="${e.value}" pattern="0.0" /></td>
                    	</c:if>
                 	</c:forEach>
                </tr>
            </table>
            <div style="padding:10px 20px;">
                <ul class="ultable">
                    <li class="wp69">分析人：<span>唐志鹏</span><div style="float:right;">复核人:冯杏玲</div></li>
