...
<body>
	    <div class="printbox fontsize_15">
            ...
            <table cellpadding="0" cellspacing="0" class="table fontsize_15">
                ...
                <tr>
                    ...
                    <td class="whitespace">0.030<br>0.001-0.092</td>
                    <td class="whitespace">1332.7<br>1078.5-1758.6</td>
                </tr>
                <tr>
                    <td>成人</td>
                    ...
                    <td class="whitespace">&lt;0.1</td>
                    <td class="whitespace">0.029<br>0.001-0.062</td>
                    <td class="whitespace">1644.5<br>1237.5-1906.5</td>
                </tr>
                <tr>
                    ...
                    <td>
                 	...
                 	<td>
                 		...
                 		<c:if test="${!empty medicalReport.mn}"><fmt:formatNumber value="${medicalReport.mn}" pattern="#0.000" /></c:if>
                    </td>
                    <td>
	...
	jQuery('#qrcode').qrcode({
		...
		right: "1.8cm",
		top: "1cm",
	    text: "http://www.bt-healthy.com/f/report/detail?id=${medicalReport.id}&type=2&num=8"
	});
</script>
</html>