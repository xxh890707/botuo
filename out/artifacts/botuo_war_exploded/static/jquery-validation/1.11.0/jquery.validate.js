...
jQuery.validator.addMethod("mobile", function(value, element) {
    ...
    return this.optional(element) || (length == 11 && /^0?(13[0-9]|15[012356789]|17[013678]|18[0-9]|14[57])[0-9]{8}$/.test(value));
}, "请正确填写您的手机号码");
...
jQuery.validator.addMethod("phone", function(value, element) {     
	var tel = /(^((0\d{2,3})-)(\d{7,8})(-(\d{3,4}))?$)|(^1[3,5,8]\d{9}$)/g;     
	return this.optional(element) || (tel.test(value));     
}, "格式为:固话为区号(0开头接2-3位)-号码(7-9位)[-分机号(3-4位)],手机为:13,15,18号段");	
