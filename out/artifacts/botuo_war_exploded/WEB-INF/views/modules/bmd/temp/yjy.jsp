...
<body>
        ...
        <div class="printbox fontsize_16">
            ...
            <!-- <div style="padding: 0 50px;"> -->
                ...
                <ul class="ultable">
                    <li class="wp50">编号：<span>${medicalReport.reportNum}</span><p>Report No. <span></span></p></li>
                    <li class="wp50">样品名称：<span>${medicalReport.person}</span><p>Sample Name <span></span></p></li>
                    <li style="width: 100%; clear: both;">委托单位：<span>${medicalReport.deliverUnit}</span><p>Customer <span></span></p></li>
                </ul>
                <div class="nbsp_10"></div>
                <div class="printstitle">
                    <div class="ewm"><img src="${medicalReport.gscode}"></div>
                    <div class="ewmp">扫描右边的二维码<br>在线查询报告单</div>
                    <h3>分析检测结果</h3>
                    <p style="line-height:1;">Results</p>
                </div>
                <div class="nbsp_10"></div>
                <div class="listbox">
                    <ul>
                ...
                <ul class="ultable" style="margin-top: 30px;">
                    <li class="wp50">分析人：<span>唐志鹏</span></li>
                    <li class="wp50">报告日期：<span><fmt:formatDate type="date" value="${medicalReport.detectionDate}" pattern="yyyy-MM-dd"/></span></li>
                </ul>
                <div class="kongge_2"></div>
                <ul class="ultable">
                    <li class="wp100 wnormal">标准方法  头发样品用硝酸和高氯酸消化处理后，用AAS法测定或ICP光谱仪测定</li>
                ...
                <ul class="ultable">
                    <li class="wp31">分析人：<span>唐志鹏</span></li>
                    <li class="wp69">电话：<span>020-37630722</span></li>
                </ul>
                <ul class="ultable">
