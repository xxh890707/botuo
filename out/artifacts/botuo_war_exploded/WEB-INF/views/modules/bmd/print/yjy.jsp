...
<body>
        ...
        <div class="printbox fontsize_16">
            <div class="kongge_3"></div>
            <div class="nbsp_10"></div>

            <!-- <div style="padding: 0 50px;"> -->
                
                <ul class="ultable">
                    <li class="wp50">编号：<span>${r.reportNum}</span><p>Report No. <span></span></p></li>
                    <li class="wp50">样品名称：<span>${r.person}</span><p>Sample Name <span></span></p></li>
                ...
                <div class="printstitle">
                    <div class="ewm"><img src="${r.gscode}"></div>
                ...
                <ul class="ultable" style="margin-top: 30px;">
                    ...
                    <li class="wp50">报告日期：<span><fmt:formatDate type="date" value="${r.detectionDate}" pattern="yyyy-MM-dd"/></span></li>
                </ul>
            <!-- </div> -->
