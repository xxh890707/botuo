...
<body>
        ...
        <div class="printbox_12x fontsize_15">
            <div style="position: relative;">
                ...
                <div class="ewm" style="top: 120px;"><img src="${r.gscode}"></div>
                <div class="ewmp" style="top: 140px;">扫描右边的二维码<br>在线查询报告单</div>
            </div>
            <div class="kongge" style="height: 180px;">
            ...
            <table cellpadding="0" cellspacing="0" class="table_2 fontsize_14">
                <tr>
                    ...
                    <td style="width: 50%"><span style="display: none">电话：</span><span style="margin-left: 80px;"><fmt:formatNumber value="${r.phone}" pattern="#" /></span></td>
                </tr>
                <tr>
            ...
            <table cellpadding="0" cellspacing="0" class="table_2 fontsize_14">
                <tr>
                    <td style="width: 69%">分析人：<span>唐志鹏</span></td>
