...
public class DictUtils {
	 ...
	 * @return
	 */
	public static Integer getDictSort(String type,String value){
		Dict dict = new Dict();
		dict.setValue(value);
		dict.setType(type);
