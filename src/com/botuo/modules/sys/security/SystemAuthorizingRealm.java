...
import com.botuo.modules.sys.service.SystemService;
...
//			if(StringUtils.isNotEmpty(token.getUserType()) && !token.getUserType().equals(user.getUserType())){
//				throw new AuthenticationException("msg:该帐号对应的用户类型有误!");
//			}
