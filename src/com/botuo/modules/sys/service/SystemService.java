 ...
 * 
 */
package com.botuo.modules.sys.service;
...
import com.botuo.modules.sys.utils.LogUtils;
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static void main(String[] args) {
		System.out.println(entryptPassword("abce1234!"));
		 System.out.println(entryptPassword("ecba0987~"));
	}
	...
	public void saveRole(Role role) {
		if (StringUtils.isBlank(role.getId())){
			role.setCurrentUser(UserUtils.getUser());
			role.preInsert();
			roleDao.insert(role);
		}else{
			role.setCurrentUser(UserUtils.getUser());
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public void saveMenu(Menu menu) {
		...
		if (StringUtils.isBlank(menu.getId())){
			menu.setCurrentUser(UserUtils.getUser());
			menu.preInsert();
			menuDao.insert(menu);
		}else{
			menu.setCurrentUser(UserUtils.getUser());
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public List<String> findUser(String titile){
	...
	public boolean checkRole(String roleIdentifier){
		return UserUtils.checkRole(roleIdentifier);
	}
	...
	public String checkLoginName(String oldLoginName, String loginName) {
		if(StringUtils.isNotEmpty(loginName) && loginName.indexOf(",") > -1 )loginName = loginName.substring(1);
	 ...
	 * @return
	 */
	public List<User> getUserByRoleEnname(String enname){
		Role role=new Role();
		role.setEnname(enname);
		return userDao.getUserByRoleEnname(role);
	}
