package com.botuo.modules.sys.interceptor;
...
import com.botuo.common.utils.ReflectHelper;
import com.botuo.common.utils.Tools;
import com.botuo.common.utils.jqgrid.PageModel;
	...
	private String generatePageSql(String sql,PageModel page){
		if(page!=null && Tools.notEmpty(dialect)){
			...
			if("MySql".equals(dialect)){
				...
				pageSql.append(page.getCurrentIndex()-1);
				pageSql.append(" and rownum_ <= ");
				pageSql.append(page.getCurrentIndex()+page.getPageSize()-1);
			}
