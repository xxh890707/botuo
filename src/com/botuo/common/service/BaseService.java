...
import com.botuo.common.persistence.BaseDao;
...
public abstract class BaseService {
	...
	public int getCurrval(String seq){
		return baseDao.getCurrval(seq);
	}

	public int getNextval(String seq){
		return baseDao.getNextval(seq);
	}
	public void updateSeq(String seq,int increment){
		 baseDao.updateSeq(seq,increment);
	}
